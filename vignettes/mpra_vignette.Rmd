...
The `count_barcodes` function automates the multi-step process of converting the MPRA barcode-to-variant-alle design to a per-sample count data frame.
