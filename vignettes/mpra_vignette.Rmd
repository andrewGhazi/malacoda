...
4. Compute some summary statistics for each variant, including a 95% transcription shift highest density interval and (based on that and the ROPE) a binary call for variant function (the `is_functional` column).
